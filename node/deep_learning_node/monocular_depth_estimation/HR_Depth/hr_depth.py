...
if __name__ == '__main__':
    ...
    # Load model
    model_path = 'saved_model_lite_hr_depth_384x1280/lite_hr_depth_k_t_encoder_depth_384x1280.onnx'
    model = HR_Depth(model_path)
    ...
    while True:
        ...
        if key == 27:  # ESC
            break
        cv.imshow('HR-Depth Input', frame)
        cv.imshow('HR-Depth Output', output_image)
