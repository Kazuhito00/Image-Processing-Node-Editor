...
if __name__ == '__main__':
    ...
    # Load model
    # model_path = 'model/yolo_free_nano_640x640.onnx'
    model_path = 'model/yolo_free_nano_crowdhuman_640x640.onnx'
    model = FreeYOLO(model_path)
    ...
    while True:
        ...
        if key == 27:  # ESC
            break
        cv2.imshow('FreeYOLO', debug_image)
