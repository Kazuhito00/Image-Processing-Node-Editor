...
class Node(DpgNodeABC):
    ...
    def update(
        ...
        # ヒステリシス
        min_val = int(dpg.get_value(input_value02_tag))
        max_val = int(dpg.get_value(input_value03_tag))
        if min_val > max_val:
            min_val, max_val = max_val - 1, min_val + 1
            dpg.set_value(input_value02_tag, min_val)
            dpg.set_value(input_value03_tag, max_val)
